...
def move_origin(stl_filepath):
    ...
    bpy.ops.wm.stl_export(filepath="hull_origin_moved.stl")
...
def calculate_hull_properties(stl_filepath, draft, scale_factor, rho_water):
    ...
    bpy.ops.wm.stl_export(filepath="hull_underwater.stl") # Export the modified object as an STL file
...
if __name__ == "__main__":
    ...
    if args.move_origin:
        move_origin(args.stl_filepath)
        stl_filepath = "hull_origin_moved.stl"
    else:
